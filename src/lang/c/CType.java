...
public class CType {
	...
	public static final int T_paint = 4; // int*[]

	private static CType[] typeArray = { new CType(T_err, "error"), new CType(T_int, "int"), new CType(T_pint, "int*"),
			new CType(T_aint, "int[]"), new CType(T_paint, "int*[]"), };
