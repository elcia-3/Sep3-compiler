...
class TermMult extends CParseRule {
	...
	public void codeGen(CParseContext pcx) throws FatalErrorException {
		...
		if (left != null && right != null) {
			...
			o.println("\tJSR\tMul ; ExpressionMul:");
			o.println("\tSUB\t#" + 2 + ", R6\t; ExpressionMul:");
			o.println("\tMOV\tR1, (R6)+\t; ExpressionMul:");
...
class TermDiv extends CParseRule {
	...
	public void codeGen(CParseContext pcx) throws FatalErrorException {
		...
		if (left != null && right != null) {
			left.codeGen(pcx); // 左部分木のコード生成を頼む
			right.codeGen(pcx); // 右部分木のコード生成を頼む
			o.println("\tJSR\tDIV ; ExpressionDiv:");
			o.println("\tSUB\t#" + 2 + ", R6\t; ExpressionDiv:");
			o.println("\tMOV\tR1, (R6)+\t; ExpressionDiv:");
		}
	}
}